 ...
 */
public class OpportunityMarkedAsFavoriteNotificationHandler extends BaseEmployerNotificationHandler {
     ...
     * notificationType will be EmployerNotificationType.OPPORTUNITY_MARKED_AS_FAVORITE;
     * notifier id will be the ID of the employee who marked the opportunity;
     * ntificationEventId will be the id of the opportunity that was applied for;
     * notified array will be null as it is of no use;
     * <p/>
     * The news owner will be the employer who created the opportunity.
     *
     * @param notification
     * @return
     */
    protected List<UserNews> handleNotification(EmployerNotification notification) {
        ...
        long employeeMarkedForOpp = notification.getNotifier();
        Profile sender = profileDao.findByPrimaryKey(new Profile(), employeeMarkedForOpp);
        ...
        String newsMessage = sender.getName() + " " + Messages.OPPORTUNITY_MARKED + " " + opportunity.getTitle();
