package com.mob.forum.util.legacy.clickstream;
...
import com.mob.forum.util.legacy.clickstream.config.ClickstreamConfig;
import com.mob.forum.util.legacy.clickstream.config.ConfigLoader;
