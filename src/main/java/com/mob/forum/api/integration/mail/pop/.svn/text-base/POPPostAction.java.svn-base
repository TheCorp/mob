...
import com.mob.forum.context.standard.StandardRequestContext;
import com.mob.forum.context.standard.StandardSessionContext;
...
import com.mob.forum.view.forum.PostAction;
...
public class POPPostAction
{
    ...
    private static final MOBLogger logger =
        new MOBLogger(POPPostAction.class);
