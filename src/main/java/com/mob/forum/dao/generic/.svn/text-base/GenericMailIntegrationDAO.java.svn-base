...
{
	/**
	 * @see com.mob.forum.dao.MailIntegrationDAO#add(com.mob.forum.entities.MailIntegration)
	 */
	...
	/**
	 * @see com.mob.forum.dao.MailIntegrationDAO#delete(int)
	 */
	...
	/**
	 * @see com.mob.forum.dao.MailIntegrationDAO#find(int)
	 */
	...
	/**
	 * @see com.mob.forum.dao.MailIntegrationDAO#findAll()
	 */
	public List findAll()
	{
	...
	/**
	 * @see com.mob.forum.dao.MailIntegrationDAO#update(com.mob.forum.entities.MailIntegration)
	 */
