...
public class ViewAllContactsAction extends ActionSupport implements Preparable,SessionAware{
    /**
     * Logger for logging messages.
     */
    private static final MOBLogger LOGGER =
        new MOBLogger(ViewAllContactsAction.class);
	...
	public String loadContacts(){
		...
		contactList = contactEmployeeService.findListContacts(currentProfileId);
		LOGGER.info("contact size:"+contactList.size());
