...
public class MarkAsUnreadEmpMsgsAction extends ActionSupport {

    /**
     * Logger for logging messages.
     */
    private static final MOBLogger LOGGER =
        new MOBLogger(MarkAsUnreadEmpMsgsAction.class);
	...
	public String markAsUnReadMsgs(){
		LOGGER.info("Inside markAsUnReadMsgs" );
