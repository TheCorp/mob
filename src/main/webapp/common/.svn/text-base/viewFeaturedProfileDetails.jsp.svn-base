...
<div id="bc_main_outer">
	...
	<div id="bc_main_mid">
		...
		<ul>
        <li>
            <s:url id="viewProfile" action="viewFeaturedProfile.action">
				   <s:param name="profile.id" value="employeeProfileId"/>
			</s:url>
            <s:a href="%{viewProfile}">View Profile</s:a></li>            
       
      <li class="active">
      <s:url id="viewProfileDetails" action="viewFeaturedProfileDetails.action">
		   <s:param name="profile.id" value="employeeProfileId"/>
	  </s:url>
	  <s:a href="%{viewProfileDetails}">View Profile Details</s:a>
       ...
       <li class="align-right"><s:a href="%{listfeedbacks}">Profile Feedback:<span id="positiveid"><s:property value="possitiveSize"/></span></s:a></li>
...
<div class="bc_light_box"><div class="bc_lb-tr"><div class="bc_lb-bl"><div class="bc_lb-br"><div class="bc_lb-content">
	...
	<div id="bc_profile_pic_spot">
		...
		<div class="bc_pps_pic">
			<div id="bc_profile_pic">
			  <img align="top" src="${ctx}<s:property value="employeeProfile.picture"/>" alt="N/A" width="130" height="100"/>
			</div>
		</div>
	...
	<div id="bc_profile_quicklinks">
	    <div class="bcp_ql" id=" ">
         ...
         <div class="bcp_ql" id="bcp_ql_contact">
         <!--
         <a href="#" onclick="return pop_up_feedback(event,'feedback',['center',300])"><img
