			...
			<div class="bc_box">
				...
				<div class="bcb_nav">
					<ul>
                        ...
                        <s:a href="%{viewEmployerphotos}"><div class="bcb_n_icon"><img src="${ctx}/styles/default/images/mobc_bcbn_icon_photoq..png" alt="" /></div><div class="bcb_n_link">Photos</div></s:a>
                        </li>
				...
				<div id="bcb_controw">
	               ...
	               <display:column property="photoCategory" title="Category" class=""></display:column>
