			...
			<div class="bc_box">
				...
				<div class="bcb_nav">
					<ul>
						...
						<s:a href="%{viewEmployerBriefcase}"><div class="bcb_n_icon"><img src="${ctx}/styles/default/images/mobc_bcbn_icon-document-selected.png" alt="" /></div><div class="bcb_n_link">Documents</div></s:a>
						</li>
				...
				<div id="bcb_controw">
	               ...
	               <display:column property="doumentCategory" title="Category" class=""></display:column>
