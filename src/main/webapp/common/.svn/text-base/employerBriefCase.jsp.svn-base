...
<div id="your_briefcase">
			<div class="bc_box">
				...
				<div class="bcb_nav">
					<ul>
						<li><a href="employerBriefcase.action"><div class="bcb_n_icon"><img src="${ctx}/styles/default/images/mobc_bcbn_icon-document-selected.png" alt="" /></div><div class="bcb_n_link">Documents</div></a></li>
				...
				<div id="bcb_controw">
					...
					<s:set name="id" value="documentsListFromBriefcase" scope="request"/>
	                ...
	                <display:column title="Type" scope="col" property="image">
		               <!-- <div class="bc_tbl_profpic">
		                <div class="bc_info_btn"></div>
						<img src="${ctx}/styles/default/images/mobc_briefcase_icon-music.png" alt="" />
						</div>
	               -->
	               </display:column>
	               ...
	               <display:column property="links" title=""></display:column>
	                <display:setProperty name="basic.msg.empty_list" value="Upload Documents to share with your contacts!"/>
...
<div id="confirm_delete" class="popup1"><div class="popup1-content">
	<div class="pu_row">
		...
		<div class="pu_col right">
				...
				<a class="second_a" href="#" id="delete" onclick="deleteEmployerBriefcaseDocument()">
...
<div id="add_item" class="popup1"><div class="popup1-content">
	<div class="pu_row">
		...
		<form action="${ctx}/employer/addEmployerItem.action" method="post"  enctype="multipart/form-data">
		<input type="hidden" name="profile.id" value=<s:property value="currentProfileId"/> >
			<h4>Name of Item</h4>
			...
			<!--<h4>Category</h4>
			<s:select name="category" headerKey="1" headerValue="" id="categoryId"
				list="%{#{'Document':'Document'}}">
			</s:select>
			
			<input type="text" name="category" id="categoryId" value="Document" readonly="readonly" style="width:65px">
			...
			<div class="submit_btn"><input type="image" src="${ctx}/styles/default/images/grn_add_item_btn-up.png" onclick="return addEmployerBriefcaseDocument()"/></div>
			<div class="ftos">By uploading a file you certify that you have the right to distribute this content and that it does not violate the Terms of Service.</div>
		</form>
    ...
    <div class="popup1-content">
        <div class="pu_row">
            ...
            <span style="display:none" id="success">                    
             ...
             <h6>Title should have less than 45 characters.<a href="#" onclick="return hide_pop_up('confirm_delete2')">Close</a></h6>
             </span> 
