...
<div class="bcb_header">
	...
	<span style="float: right;">
		<mob:flag key="2" src="../styles/default/images/icon_help.png"></mob:flag>
	</span>
</div>
...
<div class="bcb_nav">
    <ul>
        ...
        <li>
	        <s:url id="Briefcase" action="Briefcase">
         ...
         <a href="${ctx}/employee/Briefcase.action?profile.id=<s:property value="profile.id"/>">
            <div class="bcb_n_icon">
            	<img src="${ctx}/styles/default/images/mobc_bcbn_icon-document-selected.png" alt=""/>
            </div>
        ...
        <div class="pu_row">
            ...
            <div class="pu_col right">
                ...
                <a href="#" onclick="return hide_pop_up('confirm_delete')"><img
                        ...
                        <a class="" href="#"
                        id="delete"
                        onclick="deleteBriefcaseDocument()">
    ...
    <div class="popup1-content">
        <div class="pu_row">
         ...
         <span style="display:none;margin-top:30px;color: red" id="nameId1">                    
            ...
            <form action="${ctx}/employee/addItem.action" method="post" enctype="multipart/form-data">
             ...
             <h4>Name of Item</h4>
                ...
                <div class="pu_row">
                    <div class="pu_col left">
                        ...
                        <div class="pu_col" style="margin-left:30px;"><!--
                        <h4 style="margin-left: 30px;">Category</h4>
                ...
                <div class="submit_btn"><input type="image" src="${ctx}/styles/default/images/grn_add_item_btn-up.png"
                                               onclick="return addBriefcaseDocument()"/></div>
