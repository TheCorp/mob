				...
				<div class="bc_lb-content">
				  ...
				  <div class="row2">			
                   ...
                   <br clear="all" />
					 ...
					 <input type="hidden" name="inboxid" value="<s:property value="inbox.id"/>" id="inBoxId">
                   ...
                   <input type="hidden" value="<s:property value='inbox.associatedOwnerProfile.id'/>" id="associtedProfileId"/>
                    <input type="hidden" value="<s:property value='inbox.messageType'/>" id="messageType"/>
						
					<div class="row"></div>
					<hr align="center" size="1" noshade />
                    <div style = "width: 410px; float: left;">
	                    <s:a href="${ctx}/employee/myInbox.action">
	                    <img src="${ctx}/styles/default/images/msg_inbox.gif" width="130" height="33" />
	                    </s:a>
                    ...
                    <s:a href =" " id="deleteReadMsgs" onclick="deleteRecdReadMsgs()">Delete</s:a>
                    </div>
                    <br /><br />
				</div></div></div></div></div>
			</div>
...
<script src="<c:url value='/styles/default/js/groupRequest.js'/>" type="text/javascript">
</script>
