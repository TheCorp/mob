...
<div class="bcb_nav">
    <ul>
        ...
        <li><a href="employerBreifcaseAudio.action">
            <div class="bcb_n_icon"><img src="${ctx}/styles/default/images/mobc_bcbn_icon-audio.png" alt=""/>
            </div>
...
<div class="bcb_controw-right">
    <display:table name="${id}" id="id" class="bc_bc_table2" cellspacing="0"
                   ...
                   decorator="com.mob.util.EmployerBriefCaseURL">
        ...
        <display:setProperty name="basic.msg.empty_list" value="Add URL to share with your contacts!"/>
    ...
    <div class="popup1-content">
        <div class="pu_row">
            ...
            <div class="pu_col right">
                ...
                <a class="" href="#"   id="delete"  onclick="deleteEmployerBriefcaseURL()">
    ...
    <div class="popup1-content">
	 ...
	 <span style="display:none;margin-top: 30px;color: red" id="nameId">                    
         ...
         <span style="display:none;margin-top:30px;color: red" id="nameId1">                    
            ...
            <form action="${ctx}/employer/addEmployerBriefcaseURLItem.action" method="post" enctype="multipart/form-data">
                ...
                <input type="image" src="${ctx}/styles/default/images/grn_add_item_btn-up.png"
                                               onclick="return addEmployerBriefcaseURL()"/></div>
                <div class="ftos">By adding a URL you certify that you have the right to distribute this content and
