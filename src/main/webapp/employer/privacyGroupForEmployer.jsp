					...
					<form id="privacyGroupsForm">
						...
						<div class="privacy_groups_container">
							<div class="sel_prof_headers">
								<div class="sel_prof_col spc_privacygroup"><h3>Privacy Group</h3></div>
								<div class="sel_prof_col spc_accessto"><h3>Access To</h3></div>
								<div class="sel_prof_col spc_datecreated"><h3>Date Created</h3></div>
							</div>
							<div id="privacygroups">
							<s:iterator value="privacyGroupDetailsList" status="rowstatus" >
							<div class="sel_prof_row">
								<div class="sel_prof_col spc_privacygroup"><s:property value="name"/></div>
						...
						<div id="addPrivacyGroup">
							...
							<span class="input_gi"><span class="input_gi-l"><span class="input_gi-r"><input type="text" class="txt" id="groupName" name="group_name" /></span></span></span>
							<img class="add_btn" src="${ctx}/styles/default/images/add_entry_btn-up.png" onclick="addPrivacygroup();" />
							<h5><span style="display:none;color:black" id="privacygroupEmpty">
...
<script src="<c:url value='/styles/default/js/addPrivacyGroupForEmployer.js'/>"	type="text/javascript"></script>
