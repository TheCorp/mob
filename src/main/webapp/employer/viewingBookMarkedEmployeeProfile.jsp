	...
	<div id="bc_main_mid">
		...
		<div class="bc_main_inner clear-both">
			<div id="outerlgb"><div class="lgrey_box"><div class="lgrey_box-r"><div class="lgrey_box-b">
				...
				<h1>Viewing <s:property value="employee.firstName"/>'s <s:property value="bookMarkedEmployeeProfile.name"/> Profile</h1><h4 class="ta-left"></h4><h4 class="ta-right"></h4>
				</div>
				<div class="lgrey_simple"><div class="lgrey_simple-b"><div class="lgrey_simple-l"><div class="lgrey_simple-r"><div class="lgrey_simple-tl"><div class="lgrey_simple-tr"><div class="lgrey_simple-bl"><div class="lgrey_simple-content">
					<form id="editProfForm">
						...
						<div class="col1">
							<h3>little bit about <s:property value="employee.firstName"/>'s <s:property value="interestedEmployeeProfile.name"/> Profile.</h3>
							<div class="col1-content">
								<div class="f_line">
									<h5><em>category</em></h5>
								 <s:property value="bookMarkedEmployeeProfile.jobcategory"/>
						
								</div>
								<div class="f_line">
									<h5><em>Worktimeframe</em></h5>
									<s:property value="bookMarkedEmployeeProfile.workTimeframe"/>
								</div>
								...
								<div class="f_line" >
									...
									<div id="yearlydiv" >									
									<s:property value="bookMarkedEmployeeProfile.range"/>
									</div>
									<div id="hourlydiv" style="display: none;">
									</div>
									</div>
									<div style="width:100px">									
									<s:property value="bookMarkedEmployeeProfile.salaryType"/>
									</div>
								...
								<s:property value="bookMarkedEmployeeProfile.days"/>
						...
						<div id="addWorkExp">
							...
							<s:iterator value="employeeWorkExperience">
