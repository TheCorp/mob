			...
			<div class="bc_box">
				...
				<div class="bcb_nav">
					<ul>
                        ...
                        <li><a href="employerBreifcasePhotos.action"><div class="bcb_n_icon"><img src="${ctx}/styles/default/images/mobc_bcbn_icon_photoq..png" alt="" /></div><div class="bcb_n_link">Photos</div></a></li>
				...
				<div id="bcb_controw">
	               ...
	               <display:column property="links" title=""></display:column>
	                 ...
	                 <display:setProperty name="basic.msg.empty_list" value="Upload Photos to share with your contacts!"/>
...
<div id="confirm_delete" class="popup1"><div class="popup1-content">
	<div class="pu_row">
		...
		<div class="pu_col right">
				...
				<a class="second_a" href="#" id="delete" onclick="deleteEmployerBriefcasePhoto()">
...
<div id="add_item" class="popup1"><div class="popup1-content">
	<div class="pu_row">
	 <span style="display:none;margin-top: 30px;color: red" id="nameId">                    
		...
		<form action="${ctx}/employer/addEmployerPhotoItem.action" method="post"  enctype="multipart/form-data">
		<input type="hidden" name="profile.id" value=<s:property value="currentProfileId"/> >
			...
			<s:select name="category" headerKey="1" headerValue="" id="categoryId"
			 ...
			 <input type="text" name="category" id="categoryId" value="Photo" readonly="readonly" style="width:60px">
			-->
			...
			<div class="pu_row">
				...
				<!--<input type="file" class="txt xlg" name="locationOfItem"  />
				-->
				<s:file name="itemFile" id="fileItem"/>
				</div>
			</div>
						<div class="submit_btn"><input type="image" src="${ctx}/styles/default/images/grn_add_item_btn-up.png" onclick="return addEmployerBriefcasePhoto()"/></div>
