		...
		<div class="bc_main_inner clear-both">
			<div id="outerlgb"><div class="lgrey_box"><div class="lgrey_box-r"><div class="lgrey_box-b">
				<div class="red_bar">
					...
					<h1>Book Marked Employees Profiles of <s:property value="employer.organizationName"/>'s <s:property value="opportunity.str_job_name"/> opportunity</h1>
				</div>
				<div class="lgrey_simple select_profile"><div class="lgrey_simple-b"><div class="lgrey_simple-l"><div class="lgrey_simple-r"><div class="lgrey_simple-tl"><div class="lgrey_simple-tr"><div class="lgrey_simple-bl"><div class="lgrey_simple-content">
				 <s:if test="listOfBookMarkedEmployeesProfiles.size!=0">
				<h2>Profiles</h2>
		    <s:iterator value="listOfBookMarkedEmployeesProfiles">
			<div class="sel_prof_row">
				<s:url id="view" action="viewingBookMarkedEmployeeProfile">
				<s:param name="bookMarkedEmployeeProfile.id" value="id"/>
				</s:url>
			...
			<div class="sel_prof_col spc_notes"><s:property value="jobcategory"/></div>
			</div>
	        </s:iterator>
			</s:if>
			 <s:if test="listOfBookMarkedEmployeesProfiles.size==0">No Profiles Found</s:if>
