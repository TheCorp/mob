...
/*  End of jquery.dimensions.js */

/*  Start of jquery.autocomplete.js */
...
/*  End of jquery.autocomplete.js */

/*  Start of jquery.autocompleteefb.js */
/*
...
jQuery.fn.autoCompletefb = function(options)
{
    ...
    $(settings.inputClass, tmp).result(function(e, d, f) {
        var f = settings.foundClass.replace(/\./, '');
                var v = '<li class="' + f + '"><span>' + d + '</span> <img class="p" src="../styles/default/images/delete.gif"/></li>';
...
/*  End of jquery.autocompleteefb.js */