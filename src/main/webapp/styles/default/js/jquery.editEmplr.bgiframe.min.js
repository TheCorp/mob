...
$.Autocompleter.Select = function (options, input, select, config) {
	...
	function fillList() {
       ...
       var str1 = str.indexOf("value=");
       if(str1 != -1){
       var str2 = str.substring(str1+7);
       var str3 = str2.indexOf('"');
      var str2 = str.substring(str1+7,str1+str3+7);
      str2 = str2.toUpperCase();
      var term1 = term.toUpperCase();
      
      if(str2.indexOf(term1) == -1)
     continue;
      }
