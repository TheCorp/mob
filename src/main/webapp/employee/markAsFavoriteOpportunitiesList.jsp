...
<div id="bc_main_outer">
	<div id="bc_main_mid">
      ...
      <ul><li>
         <a href="${ctx}/employee/myOpportunities.action">Opportunities Applied</a></li>
        <li class="active"><a href="${ctx}/employee/markAsFavoriteList.action">Marked as Favorite</a></li>
        </ul>
		</div></div>
 ...
 <s:if test="allMarkAsFavoriteList.size==0">No results found</s:if>
				  <s:if test="allMarkAsFavoriteList.size!=0">
					<div class="sel_prof_headers">
						...
						<s:iterator value="allMarkAsFavoriteList" status="rowstatus">
