...
<div id="bc_main_outer">
	<div id="bc_main_mid">
	<div class="bc_main_inner clear-both">ye
	<div id="outerlgb"><div class="lgrey_box"><div class="lgrey_box-r"><div class="lgrey_box-b">
				...
				<form id="adv_search_form" class="dbl_search_form" action="getSerchResult.action">
						...
						<div class="form_cont">
							...
							<div class="row">
								<div class="col left">
									...
									<span class="input_gi"><span class="input_gi-l"><span class="input_gi-r"><input type="text" class="txt" id="skillsid" name="skillsNeeded" />
									<input type="hidden" id="searchList" name="skillNames"/></span></span></span>
					...
					<div class="col rightsearch">
						...
						<div class="form_cont">
							<div class="row">
								<h4>Keywords</h4>
								<span class="input_gi"><span class="input_gi-l"><span class="input_gi-r"><input type="text" class="txt" name="keywords2" /></span></span></span>
							</div>
							<div class="row">
								<div class="col left">
									<h4>Skills</h4>
									<span class="input_gi"><span class="input_gi-l"><span class="input_gi-r"><input type="text" class="txt" name="skills2" /></span></span></span>
								...
								<div class="col">
									<input class="add_skill" type="image" value="Add" src="${ctx}/styles/default/images/add_entry_btn-up.png" onclick="return false;" />
								</div>
							</div>
						</div>
					</div>
				...
				<div class="r_sel_prof">
					...
					<s:url id="view" action="viewOpportunity"><s:param name="opportunityid" value="id"/>
								</s:url>
