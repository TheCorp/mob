...
<div id="bc_main_outer">
	...
	<div id="bc_main_mid">
		...
		<li class="active">
			...
			<s:a href="%{privacy}">Privacy</s:a>
			-->
			<a href="${ctx}/employee/privacy.action?profile.id=<s:property value="profile.id"/>">Privacy</a>
		</li>
		<li>
			<!--
			<s:url id="privacyGroup" action="privacyGroup.action">
		    <s:param name="profile.id" value="profile.id"/>
	   	    </s:url>
			<s:a href="%{privacyGroup}">Privacy Groups</s:a>
			-->
			<a href="${ctx}/employee/privacyGroup.action?profile.id=<s:property value="profile.id"/>">Privacy Groups</a>
		</li>
		</ul></div></div>
		<div class="bc_main_inner clear-both">
			<div id="bc_profile_sec" class="r_sel_prof">
				<div class="bc_light_box select_profile"><div class="bc_lb-tr"><div class="bc_lb-bl"><div class="bc_lb-br"><div class="bc_lb-content">
					<h2 class="prof_sub_header">Employee - Privacy Settings</h2>
					 <span id="successId" style="margin-left: 30%"><font color="green">Privacy settings updated  successfully.</font></span> 
					<p class="prof_sub_sub">Select which of your privacy groups you want to be able to see these items.</p>

					<form id="privacySettingsForm" action="addPrivacySettings.action">
					<div class="row">
							   ...
							   <div id="list" style="display: block">							
								...
								<div id="editlist" style="display: none">
									<s:select name="personalPrivacyGroups"
								       ...
								       id="selectedPersonalPrivacyGroupId">
								     </s:select>
							     </div>					     
					...
					<div class="col">
					        ...
					        <div id="desiredWorkEditList" style="display: none">
									...
									<s:select name="desiredPrivacyGroups"
								       ...
								       onchange="checkSelectedDesiredPrivacyGroups();"
								       id="selecteddesiredPrivacyGroupsId"
								       listValue="name" size="5" multiple="true">
								     </s:select>
					       </div>
					...
					<div class="col">
					        ...
					        <div id="workExperienceEditList" style="display: none">
							       ...
							       listValue="name" size="5" multiple="true"
								   onchange="checkSelectedWorkExperiencePrivacyGroup();" id="selectedWorkExperiencePrivacyGroupId">
							     </s:select>
					       </div>
					...
					<div class="col">
					        ...
					        <div id="educationEditList" style="display: none">
							       ...
							       listValue="name" size="5" multiple="true"
								   onchange="checkEducationExperiencePrivacyGroup();" id="selectedEducationExperiencePrivacyGroupId">
							     </s:select>
					       </div>
						...
						<h5><s:property value="profilePicture.name"/></h5>
					        ...
					        <div id="profilePictureEditList" style="display: none">
								...
								<s:select name="profilePicturePrivacyGroups"
							       ...
							       listValue="name" size="5" multiple="true"
								  onchange="checkProfilePicturePrivacyGroup();" id="selectedProfilePicturePrivacyGroupId">
							     </s:select>
					       </div>
					...
					<div class="col">     
					        ...
					        <div id="friendEditList" style="display: none">
								...
								<s:select name="friendListPrivacyGroups"
							       ...
							       listValue="name" size="5" multiple="true"
								   onchange="checkFriendListPrivacyGroup();" id="selectedFriendListPrivacyGroupId">
							     </s:select>
					       </div>
					...
					<a href="${ctx}/employee/privacy.action?profile.id=<s:property value="profile.id"/>">Cancel</a>
					</span>
					</div>
					</form>
