				...
				<div class="bcb_nav">
					<ul>
                        ...
                        <li>
	                        ...
	                        </div><div class="bcb_n_link">Photos</div>
	                        </a>
	                    </li>
	                    <li>
						...
						<li>
							...
							<div class="bcb_n_icon">
							<img src="${ctx}/styles/default/images/mobc_bcbn_icon-chat.png" alt="" />
							</div><div class="bcb_n_link">Chat</div>
							</a>
						</li>
...
<div id="confirm_delete" class="popup1"><div class="popup1-content">
	<div class="pu_row">
		...
		<div class="pu_col right">
				...
				<a class="second_a" href="#" id="delete" onclick="deleteBriefcasePhoto()">
...
<div id="add_item" class="popup1"><div class="popup1-content">
	<div class="pu_row">
	 <span style="display:none;margin-top: 30px;color: red" id="nameId">                    
		...
		<form action="${ctx}/employee/addEmployeePhotoItem.action" method="post"  enctype="multipart/form-data">
		<s:hidden name="profile.id"/>
			...
			<div class="submit_btn"><input type="image" src="${ctx}/styles/default/images/grn_add_item_btn-up.png" onclick="return addBriefcasePhoto()"/></div>
