				...
				<div class="bcb_nav">
					<ul>
                        ...
                        <a href="${ctx}/employee/employeeBreifcaseAudio.action?profile.id=<s:property value="profile.id"/>">
	                        ...
	                        <img src="${ctx}/styles/default/images/mobc_bcbn_icon-audio-selected.png" alt="" /></div><div class="bcb_n_link">Music/Videos</div>
	                       </a>
                        </li>
...
<div id="confirm_delete" class="popup1"><div class="popup1-content">
	<div class="pu_row">
		...
		<div class="pu_col right">
				...
				<a class="second_a" href="#" id="delete" onclick="deleteBriefcaseAudioOrVideo()">
...
<div id="add_item" class="popup1"><div class="popup1-content">
	<div class="pu_row">
	 <span style="display:none;margin-top: 30px;color: red" id="nameId">                    
		...
		<form action="${ctx}/employee/addEmployeeAudioVedioItem.action" method="post"  enctype="multipart/form-data">
		<s:hidden name="profile.id"/>
			...
			<!--<s:select name="category" headerKey="1" headerValue="" id="categoryId"
				list="%{#{'Video ':'Video ','Audio ':'Audio '}}"
				onchange="audioOrVideo();">
			</s:select>
			...
			<div class="submit_btn"><input type="image" src="${ctx}/styles/default/images/grn_add_item_btn-up.png" onclick="return addBriefcaseAudioVedio()"/></div>
